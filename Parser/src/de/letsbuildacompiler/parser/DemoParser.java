...
public class DemoParser extends Parser {
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(74); ((DivContext)_localctx).right = expression(9);
						}
						break;
					...
					case 2:
						...
						setState(76); match(6);
						setState(77); ((MultContext)_localctx).right = expression(8);
						}
						break;
					...
					case 3:
						...
						setState(79); match(5);
						setState(80); ((MinusContext)_localctx).right = expression(7);
						}
						break;
					...
					case 4:
						...
						setState(82); match(4);
						setState(83); ((PlusContext)_localctx).right = expression(6);
						}
						break;
					...
					case 5:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 9) | (1L << 14) | (1L << 16) | (1L << 20))) != 0)) ) {
							((RelationalContext)_localctx).operator = (Token)_errHandler.recoverInline(this);
						}
						consume();
						setState(86); ((RelationalContext)_localctx).right = expression(5);
						}
						break;
					}
					} 
	...
	public final VarDeclarationContext varDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(93); ((VarDeclarationContext)_localctx).varName = match(IDENTIFIER);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AssignmentContext assignment() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(95); ((AssignmentContext)_localctx).varName = match(IDENTIFIER);
			setState(96); match(11);
			setState(97); ((AssignmentContext)_localctx).expr = expression(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PrintlnContext println() throws RecognitionException {
		...
		try {
			...
			{
			setState(99); match(2);
			setState(100); ((PrintlnContext)_localctx).argument = expression(0);
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			setState(104); ((FunctionDefinitionContext)_localctx).funcName = match(IDENTIFIER);
			setState(105); match(7);
			setState(106); ((FunctionDefinitionContext)_localctx).params = parameterDeclaration();
			setState(107); match(1);
			setState(108); match(15);
			setState(109); ((FunctionDefinitionContext)_localctx).statements = statementList();
			setState(110); match(12);
			setState(111); ((FunctionDefinitionContext)_localctx).returnValue = expression(0);
	...
	public final ParameterDeclarationContext parameterDeclaration() throws RecognitionException {
		...
		try {
			...
			case 10:
				enterOuterAlt(_localctx, 1);
				{
				setState(115); ((ParameterDeclarationContext)_localctx).varDeclaration = varDeclaration();
				...
				while (_la==3) {
					...
					setState(117); ((ParameterDeclarationContext)_localctx).varDeclaration = varDeclaration();
					((ParameterDeclarationContext)_localctx).declarations.add(((ParameterDeclarationContext)_localctx).varDeclaration);
					}
					}
					setState(122);
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(132); ((FunctionCallContext)_localctx).funcName = match(IDENTIFIER);
			setState(133); match(7);
			setState(134); ((FunctionCallContext)_localctx).arguments = expressionList();
	...
	public final ExpressionListContext expressionList() throws RecognitionException {
		...
		try {
			...
			case NUMBER:
				enterOuterAlt(_localctx, 1);
				{
				setState(137); ((ExpressionListContext)_localctx).expression = expression(0);
				...
				while (_la==3) {
					...
					setState(139); ((ExpressionListContext)_localctx).expression = expression(0);
					((ExpressionListContext)_localctx).expressions.add(((ExpressionListContext)_localctx).expression);
					}
					}
					setState(144);
	...
	public static final String _serializedATN =
		...
		"\f\3\f\3\f\7\fy\n\f\f\f\16\f|\13\f\3\f\5\f\177\n\f\3\r\7\r\u0082\n\r\f"+
		"\r\16\r\u0085\13\r\3\16\3\16\3\16\3\16\3\16\3\17\3\17\3\17\7\17\u008f"+
		"\n\17\f\17\16\17\u0092\13\17\3\17\5\17\u0095\n\17\3\17\2\3\f\20\2\4\6"+
		"\b\n\f\16\20\22\24\26\30\32\34\2\3\6\2\13\13\20\20\22\22\26\26\u009a\2"+
		"\37\3\2\2\2\4%\3\2\2\2\6\61\3\2\2\2\b\63\3\2\2\2\n;\3\2\2\2\fH\3\2\2\2"+
		"\16^\3\2\2\2\20a\3\2\2\2\22e\3\2\2\2\24i\3\2\2\2\26~\3\2\2\2\30\u0083"+
